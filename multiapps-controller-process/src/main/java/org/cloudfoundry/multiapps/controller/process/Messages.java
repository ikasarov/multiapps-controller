...
public class Messages {
    ...
    public static final String DELETING_OLD_SERVICE_KEYS_FOR_SERVICE = "Deleting old unused service keys \"{0}\"...";
    ...
    public static final String UPDATING_SERVICE_KEY_METADATA_FAILED = "Updating service key metadata failed.";
